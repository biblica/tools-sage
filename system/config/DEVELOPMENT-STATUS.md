...
- The persistent ordinary Project collection is `SAGEdata/.system/state/project-inventory.json` and is described to operators as the **SAGE Project Inventory**.
