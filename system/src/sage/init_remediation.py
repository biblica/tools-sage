...
def _parse_roles(raw: str) -> list[str]:
    """Normalize and validate the project roles selected during guided INIT."""
    ...
    for project_id in selected:
        ...
        if not _yes_no(
            ...
            raise InputRequiredError(
                ...
                next_action=f"Run `{render_sage_command(['project', 'init'])}` or repeat interactively and enable the project.",
            )
