...
class SageControlCenter:
    ...
    def _system_show_paths(self) -> None:
        ...
        self.io.write(f"SAGEdata: {config.data_root}")
        ...
        while True:
            ...
            choice = self.io.choose(
                ...
                context=(
                    ...
                    f"{'SAGEdata':<28}{config.data_root}",
    ...
    def _offer_packaged_language_profile(self, exc: ValidationError) -> bool:
        ...
        self.io.write(
            ...
            "register it. Registering it changes only local SAGEdata settings; Project and Job content "
            "is not rewritten."
        )
        selected = self.io.choose(
    ...
    def system_recovery_menu(self) -> None:
        ...
        while True:
            ...
            if choice == "1":
                ...
                self.io.write("The managed SAGEdata runtime and packaged SAGE Core resources are preserved.")
    ...
    def resource_menu(self) -> None:
        ...
        while True:
            ...
            choice=self.io.choose("SCRIPTURE PROJECTS", (
                ...
                ("3","Language Profiles"),
                ("4","Validate SAGE Projects"),
                ("5","Paratext Projects root"),
                ("6","Scan Paratext Projects"),
                ("7","Original-language resources"),
            ...
            elif choice=="3": self.language_profiles_menu()
            elif choice=="4": self.validate_shared_registry()
            elif choice=="5": self.projects_root_menu()
            elif choice=="6": self.scan_rescan_projects_menu()
            elif choice=="7": self.original_language_resources_menu()
            elif choice=="8":
