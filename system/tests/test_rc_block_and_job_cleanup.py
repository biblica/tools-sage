...
def test_job_layout_audit_hash_is_stable_and_migration_is_dry_run_first(tmp_path: Path) -> None:
    ...
    assert (storage_layout(sage_root).diagnostics_root / "legacy-reports" / "jobs__saw__SAW_fixture__runs__SAW_fixture-20260818-001__reports__ACTION-REPORT.md").is_file()
