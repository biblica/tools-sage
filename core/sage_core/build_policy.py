...
BUILD_POLICY_VERSION = "0.01-rc7.04"
IMPLEMENTED_PROVIDER_IDS = ("codex", "ollama", "lmstudio")
...
def require_provider_enabled(provider: str) -> str:
    """Return a normalised enabled provider ID or fail closed under build policy."""
