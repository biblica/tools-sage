...
- Locally supplied measured-evaluation records may be stored in `localdata/.system/config/model-language-competency.yml`; SAGE does not rewrite `SYSTEM` to maintain local history.
