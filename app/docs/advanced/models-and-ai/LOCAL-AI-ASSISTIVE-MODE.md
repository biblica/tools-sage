...
Assistive provenance receipts are stored under `localdata/.system/state/local-ai-receipts/`. They are administrative state and do not mutate Job, Run, Project Scripture, or canonical report state.
