...
- all ten Skills have explicit sealed evaluation inventories and three repetitions per case; RTC includes five cases for its source-referral semantic boundaries, and every case remains one review item; inventories and hashes regenerate deterministically without provider calls;
...
- live provider qualification is run outside pytest against synthetic cases only, reviewed before
