...
- `docs/advanced/workflows/SAW-CHECK-POLICY.md`
...
- `system/skills/bic-rewrite/references/PROJECT-GRAMMAR-AND-SAW.md`
...
- `system/skills/bic-self-check/references/PROJECT-GRAMMAR-AND-SAW.md`
