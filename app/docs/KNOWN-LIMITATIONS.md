...
- v0.01beta2 enables governed BIC/RTC/STC execution through CODEX only. Ollama remains optional explicit administration tooling and cannot execute governed tasks; administrative explanations and executive summaries are deterministic. Grok/Gemini remain future provider-adapter possibilities.
