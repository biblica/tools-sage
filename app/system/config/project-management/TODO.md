...
| `TODO-20260826-002` | 2026-08-26 | `0.01beta2` | `MS-BETA2-NATIVE` | HIGH | OPEN | Complete native Windows acceptance with a real Paratext Projects root and governed BIC/SAW cycles. | Clean Beta 2 staging tree |
...
| `TODO-20260826-005` | 2026-08-26 | `0.01beta2` | `MS-BETA2-TUI` | MEDIUM | IN_PROGRESS | Finish action-capable TUI parity while retaining the classic menu and scriptable CLI. | UI-independent action services |
| `TODO-20260828-001` | 2026-08-28 | `0.01beta2` | `MS-BETA2-QUALIFY` | HIGH | OPEN | Test and harden the complete SAW Focused Check and Original-Language Review process logic, including planning, task contracts, validation, continuation, aggregation, and report publication. | Complete current STC/RTC stabilization |
