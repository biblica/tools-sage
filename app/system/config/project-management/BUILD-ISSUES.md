...
|---|---|---|---|---|---|---|
| `BI-20260826-001` | 2026-08-26 | `0.02b1` | `MS-02B1-QUALIFY` | HIGH | INVESTIGATING | External-data/Core-boundary refactor requires fresh exact-source qualification before ZIP promotion. |

### BI-20260826-001 — Refactored Core requires fresh exact-source qualification

- **Observed:** The 0.02b1 refactor moved all persistent local/operator/runtime state out of Core
