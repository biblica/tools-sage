...
9. Define a future localdata schema-migration policy before any release introduces an incompatible persisted-data schema. The first published `0.02b1` baseline requires no migration from unpublished legacy layouts.
