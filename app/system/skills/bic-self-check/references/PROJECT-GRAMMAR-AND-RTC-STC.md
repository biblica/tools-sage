...
- RTC structural and translation/meaning review: WIP contract;
- STC correspondence review: WIP contract plus the routed PRIMARY OL authority contract;
- RTC selective original-language adjudication: WIP contract plus only the bounded OL evidence explicitly routed for that stage.
