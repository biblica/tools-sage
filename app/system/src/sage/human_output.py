...
_NCA_OPTIMIZED_LABELS = {
    ...
    'mandatory_profile': {'en': 'Number Style Profile (optional)', 'id': 'Profil Gaya Angka (opsional)', 'fr': 'Profil de style numérique (facultatif)', 'ru': 'Профиль оформления чисел (необязательный)', 'pt-BR': 'Perfil de estilo numérico (opcional)', 'uk': 'Профіль оформлення чисел (необов’язковий)'},
