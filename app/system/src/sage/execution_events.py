...
_STALE_CODES = {
    ...
    "NCA_REFERENCE_PACKAGE_STALE",
    "NCA_STYLE_PROFILE_STALE",
    "NCA_WIP_SNAPSHOT_STALE",
...
_FINALIZATION_CODES = {
    ...
    "NCA_RESULT_COVERAGE_INVALID",
    "NCA_REPORT_TRANSLATION_REQUIRED",
}
_COMMIT_CODES = {
...
_BINDING_CODES = {
    ...
    "NCA_JOB_BINDING_INVALID",
    "NCA_PACKAGE_BINDING_INVALID",
