...
The default source is the corresponding bundled directory below this folder. The `0.01beta2`
...
resource. Overrides are stored in `localdata/.system/state/original-language-resources.json`; ordinary Paratext Project
