...
created, experimental, imported, or locally modified resources remain outside Core in `SAGEdata`.
...
| Plugin/extension | `SAGEdata/plugins/` | Separately versioned and validated; not Core |
| User/local resource | `SAGEdata/resources/` or Project data | Operator-owned; no SAGE Core validation claim |
