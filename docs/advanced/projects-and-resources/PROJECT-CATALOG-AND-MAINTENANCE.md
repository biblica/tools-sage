# Paratext Project Catalog and Maintenance — v0.01beta
...
The catalog at `SAGEdata/.system/state/paratext-project-catalog.json` therefore records discovery and detailed-validation state separately. User-facing summaries show **discovered**, **validated**, and **pending** counts rather than presenting raw catalog JSON.
...
Paratext Projects root: <configured path> | NOT CONFIGURED
  ...
  4. Paratext Projects root
  5. Scan Paratext Projects
  6. Original-language resources
