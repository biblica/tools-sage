...
```text
SAGEdata/.system/config/operator-overrides.yml
```
...
```text
SAGEdata/.system/config/operator-overrides.yml
SAGEdata/reports/setup/operator-review.json
SAGEdata/reports/setup/PROJECT-INIT-REPORT.md
SAGEdata/reports/initialization/auto-resolution-report.json
SAGEdata/reports/initialization/auto-resolution-report.md
```
