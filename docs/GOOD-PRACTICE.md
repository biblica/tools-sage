...
- Use Codex with ChatGPT sign-in only for RC7.04 automated execution; do not add API credentials.
- Treat Ollama/LM Studio configuration as provisioned-but-disabled in this build.
...
- Keep SAW partition units separate and aggregate only after finalisation.
